        ...
        <div class="mainmenu-wrapper">
	        <div class="container">
		        ...
		        <nav id="mainmenu" class="mainmenu">
					<ul>
						<li class="logo-wrapper"><a href="<?=$base?>"><img src="img/mPurpose-logo.png" alt="Multipurpose Twitter Bootstrap Template"></a></li>
            <!-- class="active" -->
						<li>
							<a href="<?=$base?>">Home</a>
						</li>
						<li>
							<a href="?p=corporate">Corporate</a>
						</li>
            <li>
							<a href="?p=service">Service</a>
						</li>
            <li>
							<a href="?p=galery">Galery</a>
						</li>
            <li>
							<a href="?p=artikel">Artikel</a>
						</li>
